...
<body>
    <section class="congratulations">
        ...
        <p>This is project with Proxmox + Jenkins + AWS Elastic Beanstalk + Zabbix + Docker <em>PHP</em> application is now running on own dedicated environment in the AWS&nbsp;Cloud</p>
    ...
    <section class="instructions">
        ...
        <ul>
            <li>AWS Elastic Beanstalk + AWS pipeline</li>
        </ul>
    </section>
